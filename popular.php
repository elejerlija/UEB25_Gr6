    ...
    <fieldset>
        ...
        <div class="div">
            <div class="cases-container">
                ...
                <div class="case">
                    <img src="image/popular-5.jpg" alt="Case 1" height="135">
                    <div class="progress-bar"><span style="width: 30%;"></span></div><br>
                    <h3 style="padding: 13px;">Help us to Send Food</h3>
                    <p>Raised: $5000 | Goal: $9000</p>
                    <a href="#modal4">Read More</a>
                </div>

                <div class="case">
                    <img src="image/popular-2.jpg" alt="Case 2" height="135" >
                    <div class="progress-bar"><span style="width: 50%;"></span></div><br>
                    <h3 style="padding: 13px;">Clothes For Everyone</h3>
                    <p>Raised: $6000 | Goal: $12000</p>
                    <a href="#modal5">Read More</a>
                </div>

                <div class="case">
                    <img src="image/popular-3.jpg" alt="Case 3" height="135">
                    <div class="progress-bar"><span style="width: 70%;"></span></div>
                    <h3 style="padding: 12px;">Water For All Children</h3>
                    <p>Raised: $7000 | Goal: $10000</p>
                    <a href="#modal6">Read More</a>
                </div>

                <div class="case">
                    <img src="image/popular-4.jpg" height="135" alt="Case 4">
                    <div class="progress-bar"><span style="width: 40%;"></span></div><br>
                    <h3 style="padding: 3px;">Education For Everyone</h3>
                    <p>Raised: $4000 | Goal: $8000</p>
                    <a href="#modal7">Read More</a>
                </div>

                <div class="case">
                    <img src="image/popular-1.jpg" alt="Case 5" height="135">
                    <div class="progress-bar"><span style="width: 50%;"></span></div><br>
                    <h3 style="padding: 15px;">Medical Support</h3>
                    <p>Raised: $8000 | Goal: $15000</p>
                    <a href="#modal8">Read More</a>
                </div>

                <div class="case">
                    <img src="image/popular-6.jpg" alt="Case 6" height="135">
                    <div class="progress-bar"><span style="width: 25%;"></span></div><br>
                    <h3 style="padding: 15px;">Homes for Everyone</h3>
                    <p>Raised: $2500 | Goal: $10000</p>
                    <a href="#modal9">Read More</a>
                </div>
